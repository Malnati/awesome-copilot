...
1.  **Validate Policy:** Antes de qualquer mudanca, use a JFrog MCP tool apropriada (ex.: `jfrog/curation-check`) para determinar se a versao de upgrade da dependencia e **aceitavel** segundo a Curation Policy da organizacao.
2.  **Apply Fix:**
...
3.  **Final Summary:** Seu output **deve** detalhar as checagens de seguranca feitas usando JFrog MCP tools, declarando explicitamente os **resultados da Curation Policy** e os passos de remediacao realizados.
