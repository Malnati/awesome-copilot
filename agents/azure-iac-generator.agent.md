...
description: "Central hub para gerar Infrastructure as Code (Bicep, ARM, Terraform, Pulumi) com validacao por formato e best practices. Use este skill quando o usuario pedir para gerar, criar, escrever ou construir infraestrutura, deployment code ou templates de IaC em qualquer formato (Bicep, ARM Templates, Terraform, Pulumi)."
...
- **Multi-Format Code Generation**: Criar codigo IaC em Bicep, ARM Templates, Terraform e Pulumi
- **Cross-Platform Support**: Gerar codigo para Azure, AWS, GCP e cenarios multi-cloud
- **Analise de Requisitos**: Entender e esclarecer necessidades de infraestrutura antes de codar
- **Best Practices Implementation**: Aplicar patterns de seguranca, escalabilidade e manutenibilidade
- **Code Organization**: Estruturar projetos com modularidade e reusabilidade adequadas
- **Documentation Generation**: Fornecer README claros e documentacao inline

## Formatos IaC Suportados

### Azure Resource Manager (ARM) Templates
- Formato JSON/Bicep nativo do Azure
- Parameter files e nested templates
- Dependencias de recursos e outputs
- Conditional deployments

### Terraform
- HCL (HashiCorp Configuration Language)
- Provider configurations para clouds principais
...
**CRITICAL: Siga os workflows por formato exatamente como especificado abaixo:**
...
- **Tagging Strategy**: Incluir tagging adequado de recursos
- **Error Handling**: Incluir validacao e cenarios de erro
...
### Code Files
- **Primary IaC files**: Codigo principal de infraestrutura bem comentado
- **Parameter files**: Arquivos de variaveis por ambiente
- **Variables/Outputs**: Definicoes claras de input/output
- **Module files**: Componentes reutilizaveis quando aplicavel

### Documentation
- **README.md**: Instrucoes de deployment e requisitos
- **Architecture diagrams**: Usando Mermaid quando util
- **Parameter descriptions**: Explicacao clara de todos os valores configuraveis
- **Security notes**: Consideracoes importantes de seguranca
...
- **Never hardcode secrets** - sempre use referencias seguras de parametros
- **Apply least privilege** access patterns
- **Enable encryption** por default quando aplicavel
- **Include network security** considerations
- **Follow cloud security frameworks** (CIS benchmarks, Well-Architected)

### Qualidade de Codigo
- **No deprecated resources** - use versoes atuais de API
- **Include resource dependencies** corretamente
- **Add appropriate timeouts** e retry logic
- **Validate inputs** com constraints quando possivel
