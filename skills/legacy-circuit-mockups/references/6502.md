...
O **MOS Technology 6502** e um microprocessador de 8 bits introduzido em 1975. Ele e notavel pelo baixo custo, conjunto de instrucoes eficiente e uso amplo em computadores pessoais e consoles iniciais, incluindo Apple II, Commodore 64, Atari 2600, NES (variante Ricoh 2A03) e BBC Micro.
...
## 6. Resumo do Conjunto de Instrucoes
...
* `JMP (addr)` indirect bug: page boundary wraparound
  ...
  * Exemplo: `JMP ($10FF)` le de `$10FF` e `$1000`
