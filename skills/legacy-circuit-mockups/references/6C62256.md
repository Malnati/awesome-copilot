...
O **AS6C62256** e uma **SRAM CMOS de baixo consumo de 256 Kbit (32K x 8)** fabricada pela Alliance Memory (e second-sourced por outros). Ela e totalmente compativel com pinouts comuns de SRAM de 28 pinos e e amplamente usada em sistemas de microprocessadores de 8 bits como **6502**, **Z80** e outros para memoria de leitura/escrita.

O dispositivo oferece tempos de acesso rapidos, logica de controle simples e consumo muito baixo em standby.
...
## 10. Integracao Tipica de Sistema (Exemplo 6502)
