...
Analise o contexto atual do repositorio e sugira arquivos de Custom Agents relevantes do [repositorio awesome-copilot](https://github.com/Malnati/awesome-copilot/blob/main/docs/README.agents.md) que ainda nao estao disponiveis neste repositorio. Os arquivos de Custom Agent estao na pasta [agents](https://github.com/Malnati/awesome-copilot/tree/main/agents) do repositorio awesome-copilot.

## Processo

1. **Fetch Available Custom Agents**: Extraia a lista de Custom Agents e descricoes de [awesome-copilot README.agents.md](https://github.com/Malnati/awesome-copilot/blob/main/docs/README.agents.md). Deve usar a tool `fetch`.
